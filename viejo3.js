...
function crearUsuario() {
    // Crea una Clase de ES6 o una función `contructor` llamada "Usuario"
  ...
  function invertida() {
   ...
   //esto era todo lo que se necesitaba y no funciona
    String.prototype.revertidor = function(){
    ...
    //la parte de string es la necesara y la valida el resto es practica fallida
    let variable = new revertido("FRASE")
